...
| MS-006 | M5 설정 페이지 | INT-001 | Build | In Progress | TASK-012, TASK-013, TASK-014 | | Webview **페이지**(F21·ADR-012)·호출 구성 오버레이(ADR-011)·옵션 카탈로그. **코어 우선**(012 주입·013 셸·014 호출구성 탭), export/import(TASK-015 F12)는 분리. **Cargo.toml 국소편집은 v2 이월** |
