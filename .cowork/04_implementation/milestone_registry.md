...
| MS-002 | M1 코어 타입·칩 프레임워크 | INT-001 | Build | In Progress | TASK-002, TASK-003 | | `types.ts` + 4개 어댑터 칩 스텁(Python 리트머스) + F20 createProject 계약. TASK-002·003 Review — 검토·병합 시 Done |
