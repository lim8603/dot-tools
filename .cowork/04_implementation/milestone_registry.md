...
| MS-005 | M4 실행·디버그 | INT-001 | Build | Review | TASK-010, TASK-011 | | TaskRunner·problem matcher·디버그 플로우·키바인딩 코드 완료(TASK-010·011 Review). **F5 검증 대기**(Build/Run + Debug). F19 target 자동설치·Doctor는 이월 |
