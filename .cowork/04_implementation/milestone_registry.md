...
| MS-003 | M2 CargoBridge + CargoAdapter | INT-001 | Build | Review | TASK-004, TASK-005, TASK-006 | | 메타데이터/빌드 JSON 파싱·인자 조립·features·resolveExecutable + 단위테스트. TASK-004(순수코어)·005(CLI)·006(어댑터) 모두 Review — build/run/resolveExecutable/chips/listProjects 실동작. **디버그 구성=M4, cargo createProjectTask=MS-008(F20)로 이월**. 검토 후 main 병합 |
