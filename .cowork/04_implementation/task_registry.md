...
| TASK-020 | 통합 테스트 하네스 + 수동 체크리스트 | MS-007 | INT-001 | 없음 | AI | In Progress | 2026-08-15 | 착수 — `@vscode/test-electron` 셋업 + 자동화분 + §15.2 13항목 수동 체크리스트(WSL/F18·Python 스텁 회귀 포함) → test_case/verification_evidence. **다음 착수** | TASK-016~019 | `tasks/TASK-020.md` | M6. F18 흡수 |
