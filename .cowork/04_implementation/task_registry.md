...
| TASK-040 | Run Group 통합 테스트 + 검증 + 문서 | MS-013 | INT-001 | 없음 | AI | Planned | 2026-08-17 | 통합 테스트 + test_case/verification + README/CHANGELOG. **F5 검증** → MS-013 Done, **v0.4.0 배포**(v1.0.0 아님, D-19). C-6 충족 | TASK-038 | | C-6 |
...
> 현재 등록 Task: TASK-001~042. **TASK-001~038·041 Done** (MS-001~012 + MS-013 036·037·038 **F5 통과**, unit **203**). **MS-013 Run Group(C-6)**: 엔진(036/037)+UI(038) F5 통과·스테이지 순서·skip·통합 메뉴(D-20). **다음: TASK-040**(통합테스트·검증·README/CHANGELOG → **v0.4.0**). 039(준비감지)=후속 마이너 분리. **TASK-042**=v1.0.0 완주 결정 게이트(D-19). **미커밋**(main). **C-3 폐기**(D-15). 별도 트랙: TC-11(WSL, Deferred).
