...
| TASK-019 | pre/postBuild 실행 배선 + buildEvent 편집 | MS-007 | INT-001 | US-010 | AI | In Progress | 2026-08-15 | 착수 — preBuild/postBuild 실제 실행(현재 저장만·주입 안 함) + 설정 페이지 buildEvent 에디터. C-5 해소. **다음 착수** | 없음 | `tasks/TASK-019.md` | M6. C-5 |
