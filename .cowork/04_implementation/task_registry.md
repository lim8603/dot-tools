...
| TASK-027 | DotnetBridge + listProjects + chips | MS-010 | INT-001 | US-003 | AI | Planned | 2026-08-16 | `adapters/dotnet/dotnetBridge.ts`(dotnet/msbuild CLI I/O·vscode-free·DI) + listProjects(`**/*.csproj`) + chips(profile=Debug/Release·architecture·target=TFM) 실구현. cargoBridge 패턴 준용 | 없음 | | C-7 1/3 |
