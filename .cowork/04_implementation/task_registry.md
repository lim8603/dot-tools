...
| TASK-018 | rustup target 자동 설치 | MS-007 | INT-001 | 없음 | AI | In Progress | 2026-08-15 | 착수 — 아키텍처 칩이 설치+미설치 target 열거(`rustup target list`), 미설치 선택→`rustup target add` 확인·실행. §13.4. **다음 착수** | TASK-017 | `tasks/TASK-018.md` | M6. F19 1단계 |
