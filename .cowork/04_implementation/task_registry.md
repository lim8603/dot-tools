...
| TASK-016 | Doctor 진단 모델 + 어댑터 진단 계약 | MS-007 | INT-001 | 없음 | AI | Planned | 2026-08-15 | 착수 예정 — 점검 항목 모델(상태 ✅/⚠️/❌/ℹ️·해결 3단계) + 어댑터 checks 선언(순수 코어·단위테스트). §13.5 | 없음 | `tasks/TASK-016.md` | M6. F19. **다음 착수** |
| TASK-017 | Doctor UI + E1 경고 칩 | MS-007 | INT-001 | 없음 | AI | Planned | 2026-08-15 | `devSwitcher.doctor` QuickPick·항목별 resolve 액션 + `checkToolchain`→**E1 경고 칩**→Doctor·온디맨드 취소→안내. §13.5·§5.4 | TASK-016 | `tasks/TASK-017.md` | M6. F19. MS-004 이월 E1 해소 |
| TASK-018 | rustup target 자동 설치 | MS-007 | INT-001 | 없음 | AI | Planned | 2026-08-15 | 아키텍처 칩이 설치+미설치 target 열거(`rustup target list`), 미설치 선택→`rustup target add` 확인·실행. §13.4 | TASK-017 | `tasks/TASK-018.md` | M6. F19 1단계 |
| TASK-019 | pre/postBuild 실행 배선 + buildEvent 편집 | MS-007 | INT-001 | US-010 | AI | Planned | 2026-08-15 | preBuild/postBuild 실제 실행(현재 저장만·주입 안 함) + 설정 페이지 buildEvent 에디터. C-5 해소 | 없음 | `tasks/TASK-019.md` | M6. C-5 |
| TASK-020 | 통합 테스트 하네스 + 수동 체크리스트 | MS-007 | INT-001 | 없음 | AI | Planned | 2026-08-15 | `@vscode/test-electron` 셋업 + 자동화분 + §15.2 13항목 수동 체크리스트(WSL/F18·Python 스텁 회귀 포함) → test_case/verification_evidence | TASK-016~019 | `tasks/TASK-020.md` | M6. F18 흡수 |
