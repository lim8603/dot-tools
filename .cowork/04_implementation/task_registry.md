...
| TASK-003 | 4개 어댑터 칩 선언 스텁 | MS-002 | INT-001 | US-003 | AI | Review | 2026-08-15 | 4개 어댑터 선언 완료(chips·actions·globs·capabilities·optionCatalog·configCategories, Python 리트머스). tsc(인터페이스 확정 검증)·eslint·esbuild 통과. 사용자 검토 후 병합 | TASK-002 | | M1. `feature/task-002-core-types`(TASK-002 스택) |
