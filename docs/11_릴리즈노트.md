...
DevSwitcher Tools는 여러 언어 프로젝트(Rust · C++/CMake · C++/Visual Studio · C# · Python · Go · Node.js/TypeScript)를 하나의 VSCode 상태바 UX로 전환·빌드·실행·디버그하는 VSCode 확장이다. 본 문서는 v0.1.0(2026-08-16)부터 v1.2.0(2026-08-19)까지의 전체 릴리즈 이력을 기록한다.
