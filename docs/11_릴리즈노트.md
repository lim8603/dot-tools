...
3. [v1.0.0 — 첫 안정판](#3-v100--첫-안정판-2026-08-17)
4. [v0.8.0 — Run Group 준비 감지](#4-v080--run-group-준비-감지-2026-08-17)
5. [v0.7.0 — 키보드 단축키](#5-v070--키보드-단축키-2026-08-17)
6. [v0.6.0 — Node.js/TypeScript 지원](#6-v060--nodejstypescript-지원-2026-08-17)
7. [v0.5.0 — Go 지원](#7-v050--go-지원-2026-08-17)
8. [v0.4.0 — Run Group](#8-v040--run-group-2026-08-17)
9. [v0.3.0 — 4개 언어 완성](#9-v030--4개-언어-완성-2026-08-17)
10. [v0.2.0 — 시작 마법사](#10-v020--시작-마법사-2026-08-16)
11. [v0.1.0 — 첫 릴리즈](#11-v010--첫-릴리즈-2026-08-16)

---

## 1. 개요

DevSwitcher Tools는 여러 언어 프로젝트(Rust · C++/CMake · C# · Python · Go · Node.js/TypeScript)를 하나의 VSCode 상태바 UX로 전환·빌드·실행·디버그하는 VSCode 확장이다. 본 문서는 v0.1.0(2026-08-16)부터 v1.0.0(2026-08-17)까지의 전체 릴리즈 이력을 기록한다.
...
## 4. v0.8.0 — Run Group 준비 감지 (2026-08-17)
...
## 6. v0.6.0 — Node.js/TypeScript 지원 (2026-08-17)
